...
func _ready() -> void:
	...
	if OS.get_user_data_dir().replace("\\", "/") not in ["C:/Users/freer/AppData/Roaming/Games-QA-ward-waystone-20260913-story", "C:/Users/freer/AppData/Roaming/Games-QA-ward-waystone-fixed-20260913-story"]:
		get_tree().quit(1)
		return
